...
<head>
  ...
  <!-- <link href="{{asset('css/scroable.css') }}" rel="stylesheet"> -->
...
<body>
	<div class="row"  style="background-color:#DE0B21">
			<div class="container" style="margin-left:7%;">
				<form id="scrapeadd" method="POST" name="scraptload" ></form>
				<div class="form-group">
                    <h3 style="color:#000">User Rgistration</h3>
                </div>
                <div class="form-group">
					<label class="col-xs-2 control-label" style="color:#FFFFFF ">First Name</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="fname"  id="fname" placeholder="First Name" value="" />
					</div>

					<label class="col-xs-2 control-label" style="color:#FFFFFF ;padding-left:5%;">Last Name</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="lname"  id="lname" placeholder="Last Name" onkeypress="return specialChar(event)" onpaste="return false;"> </div>                                                  
                </div>
                <div class="clearfix"></div><br/>

                 <div class="form-group">
					<label class="col-xs-2 control-label" style="color:#FFFFFF ">Email</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="email"  id="email" placeholder="Email" value="" />
					</div>

					<label class="col-xs-2 control-label" style="color:#FFFFFF ;padding-left:5%;">Mobile</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="mobile"  id="mobile" placeholder="Mobile" onkeypress="return specialChar(event)" onpaste="return false;"> </div>                                                  
                </div><div class="clearfix"></div><br/>

                 <div class="form-group">
					<label class="col-xs-2 control-label" style="color:#FFFFFF ">State</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="state"  id="state" placeholder="State" value="" />
					</div>

					<label class="col-xs-2 control-label" style="color:#FFFFFF ;padding-left:5%;">City</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="city"  id="city" placeholder="City" onkeypress="return specialChar(event)" onpaste="return false;"> </div>                                                  
                </div><div class="clearfix"></div><br/>

                 <div class="form-group">
					<label class="col-xs-2 control-label" style="color:#FFFFFF ">Password</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="password"  id="password" placeholder="Password" value="" />
					</div>

					<label class="col-xs-2 control-label" style="color:#FFFFFF ;padding-left:5%;">Confirm Password</label>
					<div class="col-xs-3">
					<input type="text" class="form-control" name="cpassword"  id="cpassword" placeholder="Confirm Password" onkeypress="return specialChar(event)" onpaste="return false;"> </div>                                                  
                </div><div class="clearfix"></div><br/>
...
/*$('#state').autocomplete({
		...
		source: function(request, response) {
   			 $.getJSON("getstate", { city: $('#state').val(),term: $('#state').val()},response);
 	 	},
		select: function(event, ui) {
			            //localityName = ui.item.value;
